...
</head><body><header><h1><?php echo SITE_NAME; ?></h1>
<nav>
<a href="<?php echo BASE_URL; ?>/">Početna</a>
<a href="<?php echo BASE_URL; ?>/index.php?page=manual">User manual</a>
<a href="<?php echo BASE_URL; ?>/index.php?page=notifications">Obavijesti</a>
